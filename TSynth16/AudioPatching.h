...
AudioEffectEnvelope      filterEnvelope13;   //xy=617,1107
AudioEffectEnvelope      filterEnvelope14;   //xy=628,300
AudioEffectEnvelope      filterEnvelope15;   //xy=636,857
AudioEffectEnvelope      filterEnvelope16;   //xy=640,604
...
AudioMixer4              pwMixer13a;         //xy=353.75,688.75
AudioMixer4              pwMixer13b;         //xy=358.75,763.75
AudioMixer4              pwMixer14a;         //xy=353.75,688.75
AudioMixer4              pwMixer14b;         //xy=358.75,763.75
AudioMixer4              pwMixer15a;         //xy=353.75,688.75
AudioMixer4              pwMixer15b;         //xy=358.75,763.75
AudioMixer4              pwMixer16a;         //xy=353.75,688.75
AudioMixer4              pwMixer16b;         //xy=358.75,763.75
...
AudioSynthWaveformDc     glide13;          //xy=124,152
AudioSynthWaveformDc     glide14;          //xy=124,152
AudioSynthWaveformDc     glide15;          //xy=124,152
AudioSynthWaveformDc     glide16;          //xy=124,152
...
AudioSynthWaveformDc     keytracking13;    //xy=216,745
AudioSynthWaveformDc     keytracking14;    //xy=236,745
AudioSynthWaveformDc     keytracking15;    //xy=216,745
AudioSynthWaveformDc     keytracking16;    //xy=236,745
...
AudioMixer4              oscModMixer13a;         //xy=550,285
AudioMixer4              oscModMixer13b;         //xy=550,305
AudioMixer4              oscModMixer14a;         //xy=550,285
AudioMixer4              oscModMixer14b;         //xy=550,305
AudioMixer4              oscModMixer15a;         //xy=550,285
AudioMixer4              oscModMixer15b;         //xy=550,305
AudioMixer4              oscModMixer16a;         //xy=550,285
AudioMixer4              oscModMixer16b;         //xy=550,305
...
AudioSynthWaveformModulated waveformMod13a;  //xy=532,678
AudioSynthWaveformModulated waveformMod13b;  //xy=535,744
AudioSynthWaveformModulated waveformMod14a;  //xy=532,678
AudioSynthWaveformModulated waveformMod14b;  //xy=535,744
AudioSynthWaveformModulated waveformMod15a;  //xy=532,678
AudioSynthWaveformModulated waveformMod15b;  //xy=535,744
AudioSynthWaveformModulated waveformMod16a;  //xy=532,678
AudioSynthWaveformModulated waveformMod16b;  //xy=535,744
...
AudioEffectDigitalCombine oscFX13;       //xy=686,1046
AudioEffectDigitalCombine oscFX14;       //xy=687,803
AudioEffectDigitalCombine oscFX15;       //xy=686,1046
AudioEffectDigitalCombine oscFX16;       //xy=687,803
...
AudioMixer4              waveformMixer13; //xy=846,774
AudioMixer4              waveformMixer14; //xy=854,1023
AudioMixer4              waveformMixer15; //xy=846,774
AudioMixer4              waveformMixer16; //xy=854,1023
...
AudioMixer4              filterModMixer13;   //xy=852,937
AudioMixer4              filterModMixer14;   //xy=855,1099
AudioMixer4              filterModMixer15;   //xy=852,937
AudioMixer4              filterModMixer16;   //xy=855,1099
...
AudioFilterStateVariable filter13;        //xy=1002,822
AudioFilterStateVariable filter14;        //xy=1022,1047
AudioFilterStateVariable filter15;        //xy=1002,822
AudioFilterStateVariable filter16;        //xy=1022,1047
...
AudioMixer4              filterMixer13;   //xy=1151,214
AudioMixer4              filterMixer14;   //xy=1155,1050
AudioMixer4              filterMixer15;   //xy=1151,214
AudioMixer4              filterMixer16;   //xy=1155,1050
...
AudioEffectEnvelope      ampEnvelope13;   //xy=1321,1045
AudioEffectEnvelope      ampEnvelope14;   //xy=1327,211
AudioEffectEnvelope      ampEnvelope15;   //xy=1321,1045
AudioEffectEnvelope      ampEnvelope16;   //xy=1327,211

AudioMixer4              voiceMixer1;     //xy=1524,570
AudioMixer4              voiceMixer2;     //xy=1524,570
AudioMixer4              voiceMixer3;     //xy=1524,570
AudioMixer4              voiceMixer4;     //xy=1524,570
...
AudioConnection          patchCord415(constant1Dc, filterEnvelope13);
AudioConnection          patchCord416(constant1Dc, filterEnvelope14);
AudioConnection          patchCord417(constant1Dc, filterEnvelope15);
AudioConnection          patchCord418(constant1Dc, filterEnvelope16);
...
AudioConnection          patchCord419(pwmLfo, 0, pwMixer13a, 0);
AudioConnection          patchCord420(pwmLfo, 0, pwMixer13b, 0);
AudioConnection          patchCord421(pwmLfo, 0, pwMixer14a, 0);
AudioConnection          patchCord422(pwmLfo, 0, pwMixer14b, 0);
AudioConnection          patchCord423(pwmLfo, 0, pwMixer15a, 0);
AudioConnection          patchCord424(pwmLfo, 0, pwMixer15b, 0);
AudioConnection          patchCord425(pwmLfo, 0, pwMixer16a, 0);
AudioConnection          patchCord426(pwmLfo, 0, pwMixer16b, 0);
...
AudioConnection          patchCord427(pwa, 0, pwMixer13a, 1);
AudioConnection          patchCord428(pwb, 0, pwMixer13b, 1);
AudioConnection          patchCord429(pwa, 0, pwMixer14a, 1);
AudioConnection          patchCord430(pwb, 0, pwMixer14b, 1);
AudioConnection          patchCord431(pwa, 0, pwMixer15a, 1);
AudioConnection          patchCord432(pwb, 0, pwMixer15b, 1);
AudioConnection          patchCord433(pwa, 0, pwMixer16a, 1);
AudioConnection          patchCord434(pwb, 0, pwMixer16b, 1);
...
AudioConnection          patchCord435(filterLfo, 0, filterModMixer13, 1);
AudioConnection          patchCord436(filterLfo, 0, filterModMixer14, 1);
AudioConnection          patchCord437(filterLfo, 0, filterModMixer15, 1);
AudioConnection          patchCord438(filterLfo, 0, filterModMixer16, 1);
...
AudioConnection          patchCord439(keytracking13, 0, filterModMixer13, 2);
AudioConnection          patchCord440(keytracking14, 0, filterModMixer14, 2);
AudioConnection          patchCord441(keytracking15, 0, filterModMixer15, 2);
AudioConnection          patchCord442(keytracking16, 0, filterModMixer16, 2);
...
AudioConnection          patchCord443(noiseMixer, 0, waveformMixer13, 2);
AudioConnection          patchCord444(noiseMixer, 0, waveformMixer14, 2);
AudioConnection          patchCord445(noiseMixer, 0, waveformMixer15, 2);
AudioConnection          patchCord446(noiseMixer, 0, waveformMixer16, 2);
...
AudioConnection          patchCord447(pwMixer13a, 0, waveformMod13a, 1);
AudioConnection          patchCord448(pwMixer13b, 0, waveformMod13b, 1);
AudioConnection          patchCord449(pwMixer14a, 0, waveformMod14a, 1);
AudioConnection          patchCord450(pwMixer14b, 0, waveformMod14b, 1);
AudioConnection          patchCord451(pwMixer15a, 0, waveformMod15a, 1);
AudioConnection          patchCord452(pwMixer15b, 0, waveformMod15b, 1);
AudioConnection          patchCord453(pwMixer16a, 0, waveformMod16a, 1);
AudioConnection          patchCord454(pwMixer16b, 0, waveformMod16b, 1);
...
AudioConnection          patchCord455(oscGlobalModMixer, 0, oscModMixer13a, 0);
AudioConnection          patchCord456(oscGlobalModMixer, 0, oscModMixer13b, 0);
AudioConnection          patchCord457(oscGlobalModMixer, 0, oscModMixer14a, 0);
AudioConnection          patchCord458(oscGlobalModMixer, 0, oscModMixer14b, 0);
AudioConnection          patchCord459(oscGlobalModMixer, 0, oscModMixer15a, 0);
AudioConnection          patchCord460(oscGlobalModMixer, 0, oscModMixer15b, 0);
AudioConnection          patchCord461(oscGlobalModMixer, 0, oscModMixer16a, 0);
AudioConnection          patchCord462(oscGlobalModMixer, 0, oscModMixer16b, 0);
...
AudioConnection          patchCord463(waveformMod13a, 0, waveformMixer13, 0);
AudioConnection          patchCord464(waveformMod13a, 0, oscFX13, 0);
AudioConnection          patchCord465(waveformMod13b, 0, waveformMixer13, 1);
AudioConnection          patchCord466(waveformMod13b, 0, oscFX13, 1);
AudioConnection          patchCord467(waveformMod14a, 0, waveformMixer14, 0);
AudioConnection          patchCord468(waveformMod14a, 0, oscFX14, 0);
AudioConnection          patchCord469(waveformMod14b, 0, waveformMixer14, 1);
AudioConnection          patchCord470(waveformMod14b, 0, oscFX14, 1);
AudioConnection          patchCord471(waveformMod15a, 0, waveformMixer15, 0);
AudioConnection          patchCord472(waveformMod15a, 0, oscFX15, 0);
AudioConnection          patchCord473(waveformMod15b, 0, waveformMixer15, 1);
AudioConnection          patchCord474(waveformMod15b, 0, oscFX15, 1);
AudioConnection          patchCord475(waveformMod16a, 0, waveformMixer16, 0);
AudioConnection          patchCord476(waveformMod16a, 0, oscFX16, 0);
AudioConnection          patchCord477(waveformMod16b, 0, waveformMixer16, 1);
AudioConnection          patchCord478(waveformMod16b, 0, oscFX16, 1);
...
AudioConnection          patchCord479(filterEnvelope13, 0, filterModMixer13, 0);
AudioConnection          patchCord480(filterEnvelope13, 0, pwMixer13a, 2);
AudioConnection          patchCord481(filterEnvelope13, 0, pwMixer13b, 2);
AudioConnection          patchCord482(filterEnvelope14, 0, filterModMixer14, 0);
AudioConnection          patchCord483(filterEnvelope14, 0, pwMixer14a, 2);
AudioConnection          patchCord484(filterEnvelope14, 0, pwMixer14b, 2);
AudioConnection          patchCord485(filterEnvelope15, 0, filterModMixer15, 0);
AudioConnection          patchCord486(filterEnvelope15, 0, pwMixer15a, 2);
AudioConnection          patchCord487(filterEnvelope15, 0, pwMixer15b, 2);
AudioConnection          patchCord488(filterEnvelope16, 0, filterModMixer16, 0);
AudioConnection          patchCord489(filterEnvelope16, 0, pwMixer16a, 2);
AudioConnection          patchCord490(filterEnvelope16, 0, pwMixer16b, 2);
...
AudioConnection          patchCord491(oscFX13, 0, waveformMixer13, 3);
AudioConnection          patchCord492(oscFX14, 0, waveformMixer14, 3);
AudioConnection          patchCord493(oscFX15, 0, waveformMixer15, 3);
AudioConnection          patchCord494(oscFX16, 0, waveformMixer16, 3);
...
AudioConnection          patchCord495(waveformMixer13, 0, filter13, 0);
AudioConnection          patchCord496(filterModMixer13, 0, filter13, 1);
AudioConnection          patchCord497(waveformMixer14, 0, filter14, 0);
AudioConnection          patchCord498(filterModMixer14, 0, filter14, 1);
AudioConnection          patchCord499(waveformMixer15, 0, filter15, 0);
AudioConnection          patchCord500(filterModMixer15, 0, filter15, 1);
AudioConnection          patchCord501(waveformMixer16, 0, filter16, 0);
AudioConnection          patchCord502(filterModMixer16, 0, filter16, 1);
...
AudioConnection          patchCord503(filter13, 0, filterMixer13, 0);
AudioConnection          patchCord504(filter13, 1, filterMixer13, 1);
AudioConnection          patchCord505(filter13, 2, filterMixer13, 2);
AudioConnection          patchCord506(filter14, 0, filterMixer14, 0);
AudioConnection          patchCord507(filter14, 1, filterMixer14, 1);
AudioConnection          patchCord508(filter14, 2, filterMixer14, 2);
AudioConnection          patchCord509(filter15, 0, filterMixer15, 0);
AudioConnection          patchCord510(filter15, 1, filterMixer15, 1);
AudioConnection          patchCord511(filter15, 2, filterMixer15, 2);
AudioConnection          patchCord512(filter16, 0, filterMixer16, 0);
AudioConnection          patchCord513(filter16, 1, filterMixer16, 1);
AudioConnection          patchCord514(filter16, 2, filterMixer16, 2);
...
AudioConnection          patchCord515(filterMixer13, ampEnvelope13);
AudioConnection          patchCord516(filterMixer14, ampEnvelope14);
AudioConnection          patchCord517(filterMixer15, ampEnvelope15);
AudioConnection          patchCord518(filterMixer16, ampEnvelope16);
...
AudioConnection          patchCord519(ampEnvelope13, 0, voiceMixer4, 0);
AudioConnection          patchCord520(ampEnvelope14, 0, voiceMixer4, 1);
AudioConnection          patchCord521(ampEnvelope15, 0, voiceMixer4, 2);
AudioConnection          patchCord522(ampEnvelope16, 0, voiceMixer4, 3);
...
AudioConnection          patchCord523(oscModMixer13a, 0, waveformMod13a, 0);
AudioConnection          patchCord524(oscModMixer13b, 0, waveformMod13b, 0);
AudioConnection          patchCord525(oscModMixer14a, 0, waveformMod14a, 0);
AudioConnection          patchCord526(oscModMixer14b, 0, waveformMod14b, 0);
AudioConnection          patchCord527(oscModMixer15a, 0, waveformMod15a, 0);
AudioConnection          patchCord528(oscModMixer15b, 0, waveformMod15b, 0);
AudioConnection          patchCord529(oscModMixer16a, 0, waveformMod16a, 0);
AudioConnection          patchCord530(oscModMixer16b, 0, waveformMod16b, 0);
...
AudioConnection          patchCord531(filterEnvelope13, 0, oscModMixer13a, 1);
AudioConnection          patchCord532(filterEnvelope13, 0, oscModMixer13b, 1);
AudioConnection          patchCord533(filterEnvelope14, 0, oscModMixer14a, 1);
AudioConnection          patchCord534(filterEnvelope14, 0, oscModMixer14b, 1);
AudioConnection          patchCord535(filterEnvelope15, 0, oscModMixer15a, 1);
AudioConnection          patchCord536(filterEnvelope15, 0, oscModMixer15b, 1);
AudioConnection          patchCord537(filterEnvelope16, 0, oscModMixer16a, 1);
AudioConnection          patchCord538(filterEnvelope16, 0, oscModMixer16b, 1);
...
AudioConnection          patchCord539(glide13, 0, oscModMixer13a, 2);
AudioConnection          patchCord540(glide13, 0, oscModMixer13b, 2);
AudioConnection          patchCord541(glide14, 0, oscModMixer14a, 2);
AudioConnection          patchCord542(glide14, 0, oscModMixer14b, 2);
AudioConnection          patchCord543(glide15, 0, oscModMixer15a, 2);
AudioConnection          patchCord544(glide15, 0, oscModMixer15b, 2);
AudioConnection          patchCord545(glide16, 0, oscModMixer16a, 2);
AudioConnection          patchCord546(glide16, 0, oscModMixer16b, 2);
...
AudioConnection          patchCord547(voiceMixer4, 0, voiceMixerM, 3);
